...
namespace SportWave.Data.Migrations
{
    ...
    [Migration("20230713110944_SCTotalPrice")]
    partial class SCTotalPrice
    {
            ...
            modelBuilder.Entity("SportWave.Data.Models.PromoCode", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("c0408389-166a-4ec0-96b7-7880cc8b629e"),
                            Code = "CODE10",
                            Value = 10,
                            isValid = true
                        },
                        new
                        {
                            Id = new Guid("01606110-678c-4b6d-866a-0310ad5e473e"),
                            Code = "CODE20",
                            Value = 20,
                            isValid = true
                        });
