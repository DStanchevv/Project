...
namespace SportWave.Data.Migrations
{
    ...
    [Migration("20230713152430_RemovePromoOrders")]
    partial class RemovePromoOrders
    {
            ...
            modelBuilder.Entity("SportWave.Data.Models.PromoCode", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("1070a268-442b-44ab-a3b4-db97a0dd89d8"),
                            Code = "CODE10",
                            Value = 10,
                            isValid = true
                        },
                        new
                        {
                            Id = new Guid("72b49963-f8f8-47d0-9de5-25dec2a90acd"),
                            Code = "CODE20",
                            Value = 20,
                            isValid = true
                        });
